...
public class DataLoader : MonoBehaviour
{
    ...
    {
        //CameraMovement.mcamera.RectBanner.ShowRectBanner();
        ...
        Debug.Log("3");
        processbar.transform.parent.parent.gameObject.SetActive(false);
        ...
        {
            if (PlayerPrefs.GetInt("LevelShowRate") >= 10)
            {
                CameraMovement.mcamera.ShowRatePopup();
            }//
            else
        ...
        ServiceLocator.GetUIViewManager.ShowUIView<UIViewSelectLevel>();
    }
